...
public class StudentsController {
	...
	public Fenye selectStu(Fenye fenye,Integer page,Integer rows,String	Name,String	Phone,
			String IsPay,Integer IsValid,String QQ,String IsReturnVist, String	minHomeTime,
		 String	maxHomeTime,
		 String	minPayTime,
		 String	maxPayTime,
		 String	minInClassTime,
		 String	maxInClassTime,
		 String	minFirstVisitTime,
		 String	maxFirstVisitTime,
